...
@Component({
  ...
  templateUrl: './admin-ip-list.component.html',
  styleUrls: ['./admin-ip-list.component.css']
})
export class AdminIpListComponent implements OnInit {
  ...
  getAdminList(type?:number){
    this.userService.adminIpList().subscribe((res:any)=>{
      if(res.status){
